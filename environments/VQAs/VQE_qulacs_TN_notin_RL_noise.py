...
def get_energy_qulacs(angles, observable,circuit, weights, n_qubits, TN_state, n_shots,
                      phys_noise = False,
                      which_angles=[]):
    """"
    ...
    expval = get_exp_val(n_qubits,circuit,observable,TN_state, n_shots, weights)
